...
def test_2():
    ...
    # Вариант для создания файлов с указанием конкретного пути
    # paths = (r"D:\Арам\Нетология\ДЗ\Продвинутая работа в Python\Декораторы\folder\log_1.log", 
    #          r"D:\Арам\Нетология\ДЗ\Продвинутая работа в Python\Декораторы\folder\log_2.log",
    #          r"D:\Арам\Нетология\ДЗ\Продвинутая работа в Python\Декораторы\folder\log_3.log")
